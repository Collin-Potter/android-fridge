...
import com.example.android_fridge.FridgeFragment
import com.example.android_fridge.ItemListFragment

const val MY_FRIDGE_PAGE_INDEX = 0
const val ITEM_LIST_PAGE_INDEX = 1

class FridgePagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
